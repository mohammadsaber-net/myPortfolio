...
import {SiJavascript,SiPostgresql,SiFramer,SiTypescript,SiTailwindcss,SiRedux,SiNextdotjs,SiVercel,SiRender,SiMongodb, SiNodedotjs} from "react-icons/si";
export default function Projects() {
 const iconMap: Record<string, React.ComponentType<any>> = {
  ...
  "SiMongodb":SiMongodb,"SiPostgresql":SiPostgresql,"SiNodedotjs":SiNodedotjs,"SiFramer":SiFramer,"SiTypescript":SiTypescript, "SiRedux":SiRedux, "SiRender":SiRender,"SiNextdotjs":SiNextdotjs,"SiVercel":SiVercel
};
